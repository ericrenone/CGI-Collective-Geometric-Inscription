...
The principle that simple local rules can generate large-scale spatial structure was demonstrated by  
**Thomas C. Schelling** in *Dynamic Models of Segregation* (1971) and *Micromotives and Macrobehavior* (1978).

In Schelling’s model, individual agents follow minimal neighborhood preferences, yet global segregation patterns emerge.

Sequential Shape Fields applies the same idea to **geometric artifacts**:

local decision rules  
→ sequential spatial updates  
...
The shared-field representation corresponds to a **marked spatial point process**, a foundational model in spatial statistics.
